...
const ProjectModal: React.FC<{
	...
	return (
		<div className="bg-fuchsia-700/90 border border-white fixed flex flex-col h-[80vh] gap-8 items-center left-1/2 p-8 rounded-lg top-1/2 w-[80vw] -translate-x-1/2 -translate-y-1/2">
			<div className="flex items-center justify-between text-3xl w-full">
				<div className="flex flex-1 justify-center w-full">
					<h1 className="bg-purple-800/90 rounded-lg text-center p-4 w-fit">
						{project.title}
					</h1>
				</div>
				<div
			...
			<div className="bg-purple-800/90 flex flex-col flex-1 justify-between p-4 rounded-lg text-lg w-fit">
